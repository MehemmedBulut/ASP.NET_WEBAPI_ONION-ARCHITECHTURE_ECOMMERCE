                    ...
                    if(actions != null)
                        foreach (var action in actions)
                        {
                            ...
                            if(attributes != null)
                            {
                                ...
                                if(!menus.Any(m=>m.Name == authorizeDefinitionAttribute.Manu))
                                {
                                    menu = new() { Name = authorizeDefinitionAttribute.Manu };
                                    menus.Add(menu);
                                }
                                else
                                {
                                    menu = menus.FirstOrDefault(m => m.Name == authorizeDefinitionAttribute.Manu);
                                }

                                Application.DTOS.Configuration.Action _action = new()
                                {
                                    ActionType = Enum.GetName(typeof(ActionType), authorizeDefinitionAttribute.Manu),
