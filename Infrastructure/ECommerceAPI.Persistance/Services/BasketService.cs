...
namespace ECommerceAPI.Persistance.Services
{
    public class BasketService : IBasketService
    {
        ...
        readonly IBasketItemWriteRepository _basketWriteRepository;
        readonly IBasketReadRepository _basketReadRepository;
        readonly IBasketItemWriteRepository _basketItemWriteRepository;
        readonly IBasketItemReadRepository _basketItemReadRepository;
        public BasketService(IHttpContextAccessor httpContextAccessor, UserManager<AppUser> userManager, IOrderReadRepository orderReadRepository, IBasketItemWriteRepository basketWriteRepository, IBasketItemWriteRepository basketItemWriteRepository, IBasketItemReadRepository basketItemReadRepository, IBasketReadRepository basketReadRepository)
        {
        ...
        private async Task<Basket?> ContetUser()
        {
        ...
        {
            Basket? basket = await ContetUser();
            if(basket != null) 
            {
        ...
        public Basket? GetUserActiveBasket
        {
            get
            {
                Basket? basket = ContetUser().Result;
                return basket;
            }
        }
    }
