...
namespace ECommerceAPI.API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(ActionType =ActionType.Reading, Definition = "Get Roles", Manu = "Roles")]
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Get Role By İd", Manu = "Roles")]
        ...
        [HttpPost("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Writing, Definition = "Create Roles", Manu = "Roles")]
        ...
        [HttpPut("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Updating, Definition = "Update Roles", Manu = "Roles")]
        ...
        [HttpDelete("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Deleting, Definition = "Delete Roles", Manu = "Roles")]
